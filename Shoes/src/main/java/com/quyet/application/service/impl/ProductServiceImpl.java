...
import com.quyet.application.entity.Promotion;
...
import com.quyet.application.model.dto.DetailProductInfoDTO;
import com.quyet.application.model.dto.PageableDTO;
import com.quyet.application.model.dto.ProductInfoDTO;
import com.quyet.application.model.dto.ShortProductInfoDTO;
import com.quyet.application.model.mapper.ProductMapper;
import com.quyet.application.model.request.CreateProductRequest;
import com.quyet.application.model.request.CreateSizeCountRequest;
import com.quyet.application.model.request.FilterProductRequest;
import com.quyet.application.model.request.UpdateFeedBackRequest;
import com.quyet.application.repository.OrderRepository;
import com.quyet.application.repository.ProductRepository;
import com.quyet.application.repository.ProductSizeRepository;
import com.quyet.application.repository.PromotionRepository;
import com.quyet.application.service.ProductService;
import com.quyet.application.service.PromotionService;
import com.quyet.application.utils.PageUtil;
...
//        Optional<ProductSize> productSizeOld = productSizeRepository.getProductSizeBySize(createSizeCountRequest.getSize(),createSizeCountRequest.getProductId());
    ...
    @Override
    public Integer countMaxItemOrder(String productId, int size) {
        ProductSize productSize = productSizeRepository.checkProductAndSizeAvailable(productId, size);
        if(productSize == null){
            return null;
        }
